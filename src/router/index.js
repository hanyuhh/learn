...
export const constantRouterMap = [
   ...
   },
  {
    path: '/charts',
    component: Layout,
    redirect: '/charts/realEstateChart',
    icon: 'tubiao',
    name:'全民营销数据分析',
    noDropdown: false,
    children: [{ path: 'realEstateChart', component: _import('charts/realEstateChart/index'), name: '重点工作部署' ,}]
  },
  {
    path: '/introduction',
    component: Layout,
...
export const asyncRouterMap = [
  ...
  //   path: '/realEstate',
  //   component: Layout,
  //   redirect: '/charts/realEstateChart/index',
  //   name: '',
  //   icon: 'tubiao',
  //   children: [
  //     // { path: 'peopleSale', component: _import('charts/realEstateChart/peopleSale'), name: '重点工作部署' },
  //     { path: 'oneWork', component: _import('home/oneWork'), name: '地产分析' },
  //     { path: 'wulian', component: _import('charts/wulianChart/index'), name: '物联分析' }, 
  //     { path: 'fanglianhang', component: _import('home/fanglianhang/oneWork'), name: '房联行分析' }, 
  //   ]
  // },
  {
    path: '/error',
  ...
  },
  {
    ...
    icon: 'tubiao',
    noDropdown: true,
    children: [{ path: 'oneWork', component: _import('home/oneWork'), name: '地产分析' }]
  },{
    path: '/home/caifuzhongxin',
    component: Layout,
    redirect: '/home/caifuzhongxin',
    icon: 'tubiao',
    noDropdown: true,
    children: [{ path: 'oneWork', component: _import('home/caifuzhongxin/oneWork'), name: '财富中心' }]
  },{
    path: '/charts',
    component: Layout,
    redirect: '/charts/wulianChart',
    icon: 'tubiao',
    noDropdown: true,
    children: [{ path: 'wulian', component: _import('charts/wulianChart/index'), name: '物联分析' }]
  },{
    path: '/charts',
    component: Layout,
    redirect: '/charts/chanyeyuanChart',
    icon: 'tubiao',
    noDropdown: true,
    children: [{ path: 'chanyeyuanChart', component: _import('charts/chanyeyuanChart/index'), name: '产业园数据分析' }]
  },{
    path: '/home',
    component: Layout,
    redirect: '/home/fanglianhang',
    icon: 'tubiao',
    noDropdown: true,
    children: [{ path: 'fanglianhang', component: _import('home/fanglianhang/oneWork'), name: '房联行分析' }]
  } 
