...
//      mapData:tempData.partnerData,
        lineData:tempData.lineData,
        rowLineData:tempData.rowBarData,
        pieData:tempData.pieData
      }
    },
    components: { barc,mapc,linec,rowline,piec,radar,table1,table2,table3,table4 },
    mounted() {
    }
  };
  </script>
